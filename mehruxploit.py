"""
    ...
    Script : MehruXploit - All in One Android Hacking ADB Toolkit  

    Copyright (C) 2025  Code With Mehru (github.com/CodeWithMehru)
...
def check_packages():
    ...
    if (
        ...
        choice = input(
            f"\n{color.GREEN}Do you still want to continue to mehruxploit?{color.WHITE}     Y / N > "
        ).lower()
...
def exit_mehruxploit():
    global run_mehruxploit
    run_mehruxploit = False
    print("\nExiting...\n")
...
def get_screenshot():
    ...
    if screenshot_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving screenshot to mehruxploit/{screenshot_location}\n{color.WHITE}"
        )
    else:
        print(
...
def screenrecord():
    ...
    if screenrecord_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving video to mehruxploit/{screenrecord_location}\n{color.WHITE}"
        )
    else:
...
def pull_file():
    ...
    if pull_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving file to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_whatsapp():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving data to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_screenshots():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Screenshots to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_camera():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Photos to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_sms():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving SMS file to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_contacts():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Contacts file to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_call_logs():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Call Logs file to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
        print(
...
def extract_apk():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving APK file to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def update_me():
    print(f"{color.YELLOW}\nUpdating mehruxploit\n{color.WHITE}")
    print(f"{color.GREEN}Fetching latest updates from GitHub\n{color.WHITE}")
    os.system("git fetch")
    print(f"{color.GREEN}\nApplying changes\n{color.WHITE}")
    os.system("git rebase")
    print(f"{color.CYAN}\nPlease restart mehruxploit{color.WHITE}")
    exit_mehruxploit()


def visit_me():
    os.system(f"{opener} https://github.com/CodeWithMehru/mehruxploit")
    print("\n")
...
def record_audio(mode):
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving recordings to mehruxploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
"""
Copyright © 2025 Code With Mehru (github.com/CodeWithMehru)
"""
