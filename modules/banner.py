...
menu3 = f"""
    ...
    {color.WHITE}34. {color.GREEN}Dump All Contacts           {color.WHITE}39. {color.GREEN}Use Keycodes (Control Device)       {color.WHITE}44. {color.GREEN}Update MehruXploit
    {color.WHITE}35. {color.GREEN}Dump Call Logs              {color.WHITE}40. {color.GREEN}Listen Mic Audio                    {color.WHITE}45. {color.GREEN}Visit MehruXploit on GitHub
   {color.YELLOW} 
...
{color.RED}[MehruXploit]   {color.WHITE}Press 'Enter' to continue attack / '0' to Go Back to Main Menu
    """
...
---------------------------------..--------..##@=@=@%@@=@@%%#@%@@*+*@@@%@@@@#%@@
   ...
   /  |/  /__  / /_  _______  _| |/ /____  / /___  (_) /_
  / /|_/ / _ \/ __ \/ ___/ / / /   // __ \/ / __ \/ / __/
 / /  / /  __/ / / / /  / /_/ /   |/ /_/ / / /_/ / / /_  
/_/  /_/\___/_/ /_/_/   \__,_/_/|_/ .___/_/\____/_/\__/  
                                 /_/                     

            {color.RED}{version}{color.WHITE}            {color.WHITE}By github.com/CodeWithMehru
"""
